...
const createEventNavigation = (main, document) => {
  const cells = [
    ['EventNavigation'],
    ['https://main--turnerbund-wyhlen--mtilburgadobe.hlx.page/events/query-index-events.json'],
  ];
...
export default {
  ...
  transformDOM: ({
    ...
    createMetadata(content, document);
